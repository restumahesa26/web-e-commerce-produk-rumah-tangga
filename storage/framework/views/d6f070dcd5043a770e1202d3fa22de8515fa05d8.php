...
<?php $__env->startSection('content'); ?>
	...
	<section class="cart bgwhite p-t-70 p-b-100">
		<div class="container">
			<form action="<?php echo e(route('proses-pay', $item->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\tubes_rolin\resources\views/pages/pay.blade.php ENDPATH**/ ?>