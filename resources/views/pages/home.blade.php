...
@section('content')
	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url({{ url('frontend/images/slider4.jpg') }});">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url({{ url('frontend/images/slider5.jpg') }});">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url({{ url('frontend/images/slider3.jpg') }});">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{{ url('frontend/images/kategori1.jpg') }}" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{{ url('frontend/images/kategori2.jpg') }}" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{{ url('frontend/images/kategori3.jpg') }}" alt="IMG-BENNER">
	...
	<section class="instagram p-t-20">
		...
		<div class="flex-w">
			...
			<div class="block4 wrap-pic-w">
				<img src="{{ url('frontend/images/instagram11.jpg') }}" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="{{ url('frontend/images/instagram12.jpg') }}" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="{{ url('frontend/images/instagram13.jpg') }}" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="{{ url('frontend/images/instagram14.jpg') }}" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="{{ url('frontend/images/instagram15.jpg') }}" alt="IMG-INSTAGRAM">
